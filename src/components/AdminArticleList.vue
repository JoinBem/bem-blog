    ...
    <div>
        <div class="article-list">
            <div class="article-instructions">
                <img src="/static/images/article-title.png" height="20" width="20">
                <span>文章列表</span>
                <img src="/static/images/add.png" height="17" width="17" @click="addArticle">
            </div>
...
export default{
    ...
    methods: {
        ...
        articlePreview: function(id){
            this.$router.push('/admin/articleList/articlePreview'+ id +'')
        },
